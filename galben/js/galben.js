...
function animatia1() {
    ...
    document.getElementById("agata-albastru").style.opacity = 0;
...
function animatia7() {
    document.getElementById("container-avion-albastru").style.animation = "avion7 4s ease-out forwards 1";
    document.getElementById("container-avion-albastru").style.display = "inline";
    document.getElementById("agata-rosu").style.opacity = 0;
    document.getElementById("agata-roz").style.opacity = 0;
    document.getElementById("agata-portocaliu").style.opacity = 0;
    document.getElementById("agata-alb").style.opacity = 0;
...
document.getElementById("agata-albastru").addEventListener("click", function(){
  setTimeout(function(){
    window.location.href ="../albastru/albastru.html";
  }, 3500);
});
